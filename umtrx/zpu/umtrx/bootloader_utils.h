...
#define FPGA_IMAGE_SIZE_BYTES 2464964
//16K
#define FW_IMAGE_SIZE_BYTES 0x3fff

#define SAFE_FPGA_IMAGE_LOCATION_ADDR 0x00000000
#define SAFE_FW_IMAGE_LOCATION_ADDR 0x006F0000
#define PROD_FPGA_IMAGE_LOCATION_ADDR 0x00300000
#define PROD_FW_IMAGE_LOCATION_ADDR 0x00600000
